...
parser.add_argument('input', default='./flowers/test/1/image_06754.jpg', nargs='?', action="store", type = str)
...
def main():
    ...
    probabilities = modelX.predict(path_image, model, number_of_outputs, device)
